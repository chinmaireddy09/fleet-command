...
argument-hint: [identify [call-sign] | sitrep | checkin <task> | call <station> | all-stations | alert <who> <what> | depends <what> | station <name> | deploy <station> | secure <station> | sweep <change> | silence | speak | state <normal|sweep running|mayday> | go | recover | countermeasures | standdown | tour | config]
---
